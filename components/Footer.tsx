          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="text-sm text-gray-400">
                <span className="font-medium text-gray-300">Version:</span> 0.1.1
              </li>
              <li className="text-sm text-gray-400">
                <span className="font-medium text-gray-300">Built with:</span> Next.js, React, Prisma
              </li>
              <li className="text-sm text-gray-400">
                <span className="font-medium text-gray-300">Database:</span> PostgreSQL
              </li>
            </ul>
          </div>
        </div>
